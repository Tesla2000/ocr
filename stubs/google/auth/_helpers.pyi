...
def copy_docstring(source_class: type) -> Callable[[object], object]: ...
...
def update_query(
    url: str, params: Mapping[str, str], remove: Sequence[str] | None = None
) -> str: ...
...
def response_log(logger: logging.Logger, response: object) -> None: ...
